...
public class FileServiceUtil {
	...
	public static List<ContaRequest> extrairRegistros( MultipartFile file ) {
		List<ContaRequest> contas = new ArrayList<ContaRequest>();
		...
		try {
			...
			while ( Objects.nonNull( linha ) ) {
				...
				contas.add( new ContaRequest( descricao, valor, situacao, dataVencimento, dataPagamento ) );
